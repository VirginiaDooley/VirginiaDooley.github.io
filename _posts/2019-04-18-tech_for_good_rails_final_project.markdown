...
Despite the fact that the ```has_and_belongs_to_many association``` worked best for my use case, this project required that I include the ability to add a writable attribute. 
